// n8n 转换节点代码 - 修复内容中日期显示问题
// 确保所有日期显示都使用 UTC 时间，避免时区转换
...
// 生成 front matter 中的日期 - 使用明确的 UTC 格式
...
// 格式化 UTC 日期用于内容显示 - 关键修复
const utcYear = publishDate.getUTCFullYear();
const utcMonth = publishDate.getUTCMonth() + 1;
const utcDay = publishDate.getUTCDate();
const utcDateDisplay = `${utcYear}/${utcMonth}/${utcDay} UTC`;
